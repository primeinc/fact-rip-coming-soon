...
+                    shadow-lg shadow-red-500/25\" aria-label=\"Actor monitoring in progress\" style=\"transform: scale(1.00429);\"></div>",
+         "impact": "serious",
+         "none": Array [
+           Object {
+             "data": Object {
...
+             "id": "color-contrast",
+             "impact": "serious",
+             "message": "Element has insufficient color contrast of 1.08 (foreground color: #0d0d0d, background color: #000000, font size: 42.0pt (56px), font weight: bold). Expected contrast ratio of 3:1",
+             "relatedNodes": Array [
+               Object {
...
+   Element has insufficient color contrast of 1.08 (foreground color: #0d0d0d, background color: #000000, font size: 42.0pt (56px), font weight: bold). Expected contrast ratio of 3:1",
+         "html": "<h1 class=\"text-center text-[28px] sm:text-[36px] md:text-[48px] lg:text-[56px] 
+                  leading-[1.1] font-bold tracking-tight\" style=\"opacity: 0; transform: translateY(34.9238px);\">The Loop Persists.</h1>",
+         "impact": "serious",
+         "none": Array [],
+         "target": Array [
+           "h1",
